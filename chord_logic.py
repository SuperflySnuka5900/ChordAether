...
def generate_sequence(seq_length, seq_key, seq_scale, extended = False):
    ...
    Args:
        ...
        key(int): key being used
        scale(str): scale being used
        extended(bool): whether seventh chords will be used
    Returns:
    ...
    # Sequence key must be an integer 0-12 inclusive.
    # Sequence scale must be one of the ones defined in 
    # set up
